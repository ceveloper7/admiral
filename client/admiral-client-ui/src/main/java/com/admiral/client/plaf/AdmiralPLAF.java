...
public final class AdmiralPLAF {
    ...
    public static JButton getOkButton(){
        ...
        b.setIcon(new ImageIcon(Objects.requireNonNull(AdmiralPLAF.class.getResource("icons/Ok24.gif"))));
    ...
    public static JButton getCancelButton(){
        JButton b = new JButton();
        b.setIcon(new ImageIcon(Objects.requireNonNull(AdmiralPLAF.class.getResource("icons/Cancel24.gif"))));
        b.setMargin(new Insets(0, 10, 0, 10));
        b.setToolTipText("OK");
        return b;
    }
